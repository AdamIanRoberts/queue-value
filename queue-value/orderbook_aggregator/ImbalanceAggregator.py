...
class ImbalanceAggregator(OrderbookAggregator):
    def __init__(
        self,
        date: datetime,
        ticker: str,
    ...
    def orderbook_states(self) -> List:
        ...
        return [(round(x, imbalance_decimals),) for x in self.imbalance_steps]
    ...
    def _discretise_orderbook(self):
        ...
        orderbook["state"] = [(i,) for i in orderbook["imbalance"]]
